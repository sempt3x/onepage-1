...
<div class="container">
        ...
        <div class="col-md-12 col-sm-12">
        	<a class="h4" href="index.php"><- Zurück</a>
                    <hr>
        <h2>Impressum</h2>
        <hr>
        <div class="row">
            <div class="col-md-12 col-sm-12">
                ...
                <br>
                <br> Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit, die Sie hier finden https://ec.europa.eu/consumers/odr/. Zur Teilnahme an einem Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle sind wir nicht verpflichtet und nicht bereit.<br>
            </div>
